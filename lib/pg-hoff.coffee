window.basePath = __dirname
window.hrequire = (n) -> return require(window.basePath + n)

{CompositeDisposable, Disposable} = require 'atom'
{$}                               = require 'space-pen'
Config                            = hrequire '/config'
PgHoffServerRequest               = hrequire '/server-request'
PgHoffConnection                  = hrequire '/connection'
PgHoffQuery                       = hrequire '/query'
PgHoffGotoDeclaration             = hrequire '/goto-declaration'
PgHoffAutocompleteProvider        = hrequire '/autocomplete-provider'
PgHoffDialog                      = hrequire '/dialog'
PgHoffStatus                      = hrequire '/status'
Query                             = hrequire '/query'
DBQuery                           = hrequire '/dbquery'
PaneManager                       = hrequire '/pane-items/manager'
HoffEyePaneItem                   = hrequire '/pane-items/hoffeye'
HistoryPaneItem                   = hrequire '/pane-items/history'
